...
export const ROLES = {
  ...
  RIT_LANDSIDE: 'RIT Landside',
  RIT_AIRSIDE: 'RIT Airside',
  GATE_AGENT: 'Gate Agent',
  CHECKIN: 'Check-in',
  RAMPA: 'Rampa',
  CAPISQUADRA: 'Capisquadra',
  NASTRO_BAGAGLI: 'Nastro Bagagli',
  AV_GENERALE: 'Aviazione Generale',
  AUTISTA: 'Autista Mezzi Complessi',
  MANUTENZIONE: 'Manutenzione',
  PRM: 'PRM',
  SECURITY: 'Security',
  SECURITY_CARRAIO: 'Security Carraio',
  CARBOIL: 'Carboil',
  ARRIVI: 'Arrivi/Lost & Found',
  CARGO: 'Cargo',
